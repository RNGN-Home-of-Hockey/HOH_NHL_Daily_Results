...
function markVersion(){const b=document.querySelector('.v8');if(!b)return;if(document.querySelector('script[src="/telegram-app/v12.js"]')){b.dataset.centerVersionLock='12';b.textContent='V12';b.setAttribute('aria-label','Center V12');return}if(!b.dataset.centerVersionLock){b.textContent='V11';b.setAttribute('aria-label','Center V11')}}
