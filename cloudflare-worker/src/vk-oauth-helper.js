...
<script src="https://unpkg.com/@vkid/sdk@3.8.8/dist-sdk/umd/index.js"></script>
</head>
...
<div id="auth"><div id="VkIdSdkOneTap"></div><div class="status" id="status">Ожидаю авторизацию…</div></div>
...
(function(){
  ...
  if(!VKID){ error.textContent='VK ID SDK не загрузился'; return; }
  VKID.Config.init({
    app:${APP_ID},
