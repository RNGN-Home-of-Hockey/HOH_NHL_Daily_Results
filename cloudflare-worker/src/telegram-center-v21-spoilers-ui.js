...
function style(){
  ...
  '.app{padding-top:56px!important}.v21SpoilerToggle{position:fixed;right:14px;top:9px;z-index:9999;width:42px;height:42px;border:1px solid #383d4b;border-radius:13px;background:#141720eF;color:#d7dae5;display:grid;place-items:center;padding:0;box-shadow:0 4px 18px #0007;backdrop-filter:blur(10px)}'+
  ...
  '.hohNoSpoilers .v19CardScore,.hohNoSpoilers .v19Score,.hohNoSpoilers .v19LastScore,.hohNoSpoilers .v15Game[data-game] .score,.hohNoSpoilers .gameCard[data-game] .score,.hohNoSpoilers .panel .gameTeams .score{font-size:0!important;color:transparent!important}'+
  '.hohNoSpoilers .v19CardScore:after,.hohNoSpoilers .v19LastScore:after,.hohNoSpoilers .v15Game[data-game] .score:after,.hohNoSpoilers .gameCard[data-game] .score:after,.hohNoSpoilers .panel .gameTeams .score:after{content:"•• : ••";font-size:12px!important;color:#a2a7b5!important;letter-spacing:1px}.hohNoSpoilers .v19Score:after{content:"•• : ••";font:950 22px/1 Arial;color:#a2a7b5!important;letter-spacing:2px}'+
  '.hohNoSpoilers .v19Market.won,.hohNoSpoilers .v19CardOdd.won{background:#13151e!important;border-color:#353847!important;color:inherit!important;box-shadow:none!important}.hohNoSpoilers .v19Market.won span,.hohNoSpoilers .v19Market.won strong,.hohNoSpoilers .v19CardOdd.won span,.hohNoSpoilers .v19CardOdd.won b{color:inherit!important}.hohNoSpoilers .v19Market.won i,.hohNoSpoilers .v15SeriesSpoiler{display:none!important}'+
...
install();hydrate();
const obs=new MutationObserver(()=>{if(!document.getElementById('v21SpoilerToggle'))install()});
