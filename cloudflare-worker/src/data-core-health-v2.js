  ...
  try {
    ...
    return json({
      ...
      counts:{
        ...
        postgame_finalized:Number(meta["postgame_ingestion.finalized"] || 0),
        postgame_advanced_pending:Number(meta["postgame_ingestion.advanced_pending"] || 0),
        winline_lifecycle_rows:Number(meta["winline_market_lifecycle.rows"] || 0),
        winline_lifecycle_games:Number(meta["winline_market_lifecycle.games"] || 0),
      },
      build:{
