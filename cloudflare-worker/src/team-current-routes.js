...
export async function handleTeamCurrentRequest(request, env, path) {
  ...
  if ((path === "/telegram-app-v24" || path === "/telegram-app") && request.method === "GET") {
    ...
    for (const src of [
      ...
      "/telegram-app/v15-core.js?build=24.8.0",
      "/telegram-app/v15-team.js?build=24.8.0",
      "/telegram-app/v19.js?build=24.8.0",
      "/telegram-app/v20.js?build=24.8.0",
      "/telegram-app/v21.js?build=24.8.0",
