...
*{box-sizing:border-box}html,body{margin:0;width:100%;height:100%;background:transparent!important;overflow:hidden;font-family:Arial,sans-serif}.stage{position:fixed;inset:0;pointer-events:none}.aircard{--team-color:#00e6c3;position:absolute;left:64px;bottom:70px;width:900px;height:250px;color:#fff;opacity:0;transform:translateY(26px);transition:opacity .25s ease,transform .25s ease}.aircard.on{opacity:1;transform:none}.factbar{position:absolute;left:0;right:0;top:0;height:76px;border:1px solid #5a5a60;border-radius:14px;background:linear-gradient(135deg,rgba(21,21,23,.98),rgba(8,8,10,.98));display:flex;align-items:center;padding:0 28px 0 43px;overflow:hidden;box-shadow:0 7px 24px rgba(0,0,0,.34)}.teamstripe{position:absolute;left:0;top:9px;bottom:9px;width:8px;border-radius:5px;background:var(--team-color);box-shadow:0 0 15px var(--team-color)}.facttext{font-size:25px;line-height:1;font-weight:900;letter-spacing:-.025em;text-transform:uppercase;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.facthot{color:#ff641e}.betpanel{position:absolute;left:0;right:0;top:88px;height:158px;border:1px solid #5a5a60;border-radius:15px;background:linear-gradient(135deg,rgba(16,17,19,.98),rgba(6,7,8,.98) 72%,rgba(15,16,18,.98));overflow:visible;box-shadow:0 9px 28px rgba(0,0,0,.38)}.teammark{position:absolute;left:0;top:0;width:164px;height:156px;border-right:1px solid #35353a;border-radius:14px 0 0 14px;background:linear-gradient(135deg,color-mix(in srgb,var(--team-color) 20%,#060708),#060708 70%);display:grid;place-items:center;overflow:hidden}.teammark img{width:122px;height:122px;object-fit:contain}.teammark span{font-size:24px;font-weight:900;color:#aaa}.betcopy{position:absolute;left:164px;top:0;width:330px;height:156px;padding:30px 22px;display:flex;flex-direction:column;justify-content:center;overflow:hidden}.betteam{font-size:39px;line-height:1;font-weight:900;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.betdesc{margin-top:14px;font-size:23px;line-height:1;font-weight:900;color:#d0d0d4;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.winlinebrand{position:absolute;left:61%;top:31px;transform:translateX(-50%);width:220px;height:62px;display:grid;place-items:center}.winlinebrand svg{display:block;width:220px;height:auto}.oddsbox{position:absolute;right:0;top:-1px;width:180px;height:104px;background:linear-gradient(135deg,#176eff,#0b4df5);color:#fff;clip-path:polygon(12% 0,100% 0,92% 100%,0 100%);display:grid;place-items:center;padding:0 14px 0 25px;font-size:58px;line-height:1;font-weight:900;font-style:italic;letter-spacing:-.055em;border-radius:0 14px 0 0}.profitbox{position:absolute;right:-1px;bottom:-1px;width:58%;height:62px;border:1px solid #5b5b61;border-radius:14px;background:linear-gradient(135deg,rgba(25,25,28,.99),rgba(8,8,10,.99));display:flex;align-items:center;justify-content:center;gap:12px;padding:0 18px;white-space:nowrap;overflow:hidden}.profitbox strong{font-size:25px;color:#ff641e;font-weight:900}.profitbox span{font-size:14px;color:#c9c9ce;font-weight:850}
</style></head><body><div class="stage"><div class="aircard" id="card"><div class="factbar"><span class="teamstripe"></span><div class="facttext" id="fact"></div></div><div class="betpanel"><div class="teammark" id="teammark"></div><div class="betcopy"><div class="betteam" id="team"></div><div class="betdesc" id="market"></div></div><div class="winlinebrand"><svg viewBox="0 0 260 72" aria-label="Winline"><rect x="2" y="2" width="256" height="68" rx="34" fill="#090909" stroke="#ff641e" stroke-width="6"/><text x="24" y="49" fill="#fff" font-family="Arial Black,Arial,sans-serif" font-size="38" font-weight="900" font-style="italic" letter-spacing="-2">WINLINE</text><circle cx="226" cy="36" r="23" fill="#ff641e"/></svg></div><div class="oddsbox" id="odds"></div><div class="profitbox"><strong id="profit"></strong><span>(ПРИ СТАВКЕ 1000 РУБ.)</span></div></div></div></div><script>
