...
const CENTER_POLL_SETUP_KEY = "telegram_center_poll_setup_v14";
const CENTER_MINI_APP_BUILD = "24.4.0";
const CENTER_CANONICAL_MINI_APP_PATH = "/telegram-app-v24";
const CENTER_DEFAULT_MINI_APP_URL = "https://hoh-nhl-daily-results.znamteam-903.workers.dev/telegram-app-v24?build=24.4.0";
