...
`GITHUB_DISPATCH_TOKEN` can be a fine-grained GitHub token for `RNGN-Home-of-Hockey/HOH_NHL_Daily_Results` with `Contents: Read and write`, because the Worker uses the repository dispatch endpoint.
