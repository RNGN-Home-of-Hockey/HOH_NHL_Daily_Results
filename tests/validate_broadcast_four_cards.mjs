...
const cards=[
  ...
  {id:"h2h-total",category:"h2h_market",air_score:86,broadcast_title:"ТБ 5,5 ПРОШЁЛ В 5 ИЗ 6 ОЧНЫХ МАТЧЕЙ",evidence:{split:"h2h",hits:5,sample:6,hit_rate:.833,window:6},market:{type:"game_total",subject:null,side:"over",line:5.5,label:"ТБ 5.5",odds:1.91,...real}},
